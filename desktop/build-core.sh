...
SHARED="Library Store WordLists Extras Routes Yomitan HtmlText MarkupFix Deinflect Fsrs MdictFile ZipSource Lzo Ripemd128 BookParser Sync Books Comics MihonBackup Ocr Spacing Lyrics"
